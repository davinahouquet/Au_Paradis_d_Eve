 ...
 */
final class Version20231010084525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_reservations_id INT DEFAULT NULL, espace_id INT NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, telephone INT NOT NULL, nb_personnes INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, prix_total DOUBLE PRECISION NOT NULL, options JSON DEFAULT NULL, note DOUBLE PRECISION DEFAULT NULL, avis LONGTEXT DEFAULT NULL, INDEX IDX_42C84955CB7B94E6 (user_reservations_id), INDEX IDX_42C84955B6885C6C (espace_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(10) NOT NULL, pseudo VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, adresse VARCHAR(100) DEFAULT NULL, cp VARCHAR(10) DEFAULT NULL, ville VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955CB7B94E6 FOREIGN KEY (user_reservations_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955CB7B94E6');
