 ...
 */
final class Version20231219161738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, espace_id INT NOT NULL, user_id INT DEFAULT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, telephone INT NOT NULL, nb_personnes INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, prix_total DOUBLE PRECISION DEFAULT NULL, options JSON DEFAULT NULL, note DOUBLE PRECISION DEFAULT NULL, avis LONGTEXT DEFAULT NULL, email VARCHAR(100) DEFAULT NULL, adresse_facturation VARCHAR(255) DEFAULT NULL, facture VARCHAR(255) DEFAULT NULL, date_reservation DATETIME DEFAULT CURRENT_TIMESTAMP, INDEX IDX_42C84955B6885C6C (espace_id), INDEX IDX_42C84955A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(50) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, cp VARCHAR(10) DEFAULT NULL, ville VARCHAR(50) DEFAULT NULL, pays VARCHAR(50) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
